...
INSERT INTO `account` VALUES (11, 'cczrz', '395798dc05f7b5bcadea1eda8b083f1e', '小仙女菜菜', '1');
INSERT INTO `account` VALUES (12, 'test9', 'e10adc3949ba59abbe56e057f20f883e', 'test9', '1');
INSERT INTO `account` VALUES (13, 'test10', 'e10adc3949ba59abbe56e057f20f883e', 'test10', '1');
COMMIT;
...
INSERT INTO `comment` VALUES (1297192, '小仙女菜菜', 0.5, '垃圾网站,5分钟登录,什么都不能用,垃圾垃圾.还跟我说什么我是底层用户', '2018-05-08 21:49:47', 0, 0);
COMMIT;
...
INSERT INTO `movies` VALUES (26942631, 'Hindi Medium', '一对印度的中产阶级夫妇:服装店老板拉吉（伊尔凡·可汗 Irrfan Khan 饰）与太太米塔（萨巴·卡玛尔 Saba Qamar 饰）为了让女儿皮娅（蒂希塔·塞加尔 Dishita Sehgal 饰）接受更好的教育想尽了各种办法。而当他们费劲心思终于要将女儿送进名校时,事情却又发生了意想不到的变化……', 8.0, 58850, '起跑线 / 人生起跑线(台)', 'https://img1.doubanio.com/view/photo/s_ratio_poster/public/p2517518428.jpg', '印度', '萨基特·乔杜里', '伊尔凡·可汗 / 萨巴·卡玛尔 / 内哈·迪胡皮阿 / 迪帕克·迪布里亚尔 / 蒂希塔·塞', 2017, '剧情 / 喜剧');
COMMIT;
